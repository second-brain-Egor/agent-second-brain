...
# 2026-09-04 — Исправлен контроль остановки Forumhouse

- Зафиксирован пропущенный инцидент: загрузка остановилась из-за ошибки скачивания изображения, но прежняя проверка только писала предупреждение в локальный журнал и не отправляла его в Telegram.
- Дополнительно найден дефект проверки процессов: `pgrep` мог принять собственную командную строку проверки за работающий загрузчик.
- Добавлены однократные Telegram-оповещения об остановке/зависании, недоступности Барыги, достижении 5 ГБ свободного места и критического уровня 3 ГБ, а также сообщение о восстановлении.
- По уточнению Егора проверка настроена один раз в сутки в случайное время с 12:00 до 17:00 по Москве.
