...
4. Прочитать текст, сделать краткое содержание. Перед написанием аннотации прочитать раздел «Понятные аннотации к разборам видео» в [общих правилах обработки видео](../../../thoughts/learnings/reliable-video-processing-pipeline.md) и применять его в ответе пользователю.
